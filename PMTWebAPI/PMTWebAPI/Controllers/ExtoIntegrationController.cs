                   ...
                   // var CoverLetterDate = httpRequest.Params["CoverLetterDate"];
                    ...
                    if (!sError)
                    {
                        ...
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            ...
                            int cnt = db.InsertDocumentVersion(Guid.NewGuid(), StatusUID, new Guid(DocumentUid), Extn, documentPagePath, Comments, CoverPagePath);
                            if (cnt > 0)
                            {
                        ...
                        if (!sError)
                        {
                           ...
                           new Guid(UserUID), remarks, Status, referenceNumber, Document_Date, CoverPagePath, "NotAll", "Contractor");
                                        ...
                                        else
                                        {
                                           ...
                                           int cntattach = db.InsertDocumentsAttachments(Guid.NewGuid(), new Guid(actualdocumentUID), StatusUID, sFileName, DocumentPagePath, new Guid(UserUID), DateTime.Now);
